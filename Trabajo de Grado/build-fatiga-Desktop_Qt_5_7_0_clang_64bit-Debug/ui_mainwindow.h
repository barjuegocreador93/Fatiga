...
public:
    ...
    QLabel *label_2;
    QCustomPlot *HistRainflow;
    QLabel *lbl_rflow;
    QCustomPlot *HistSmRainflow;
    QLabel *lbl_SmRainflow;
    QMenuBar *menuBar;
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        horizontalLayoutWidget->setGeometry(QRect(10, 0, 561, 32));
        ...
        HistPressPlot->setGeometry(QRect(10, 250, 531, 191));
        label_2 = new QLabel(centralWidget);
        label_2->setObjectName(QStringLiteral("label_2"));
        label_2->setGeometry(QRect(20, 230, 151, 17));
        HistRainflow = new QCustomPlot(centralWidget);
        HistRainflow->setObjectName(QStringLiteral("HistRainflow"));
        HistRainflow->setGeometry(QRect(660, 60, 401, 161));
        lbl_rflow = new QLabel(centralWidget);
        lbl_rflow->setObjectName(QStringLiteral("lbl_rflow"));
        lbl_rflow->setGeometry(QRect(660, 40, 151, 16));
        HistSmRainflow = new QCustomPlot(centralWidget);
        HistSmRainflow->setObjectName(QStringLiteral("HistSmRainflow"));
        HistSmRainflow->setGeometry(QRect(560, 250, 501, 191));
        lbl_SmRainflow = new QLabel(centralWidget);
        lbl_SmRainflow->setObjectName(QStringLiteral("lbl_SmRainflow"));
        lbl_SmRainflow->setGeometry(QRect(560, 230, 151, 16));
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        lbl_rflow->setText(QApplication::translate("MainWindow", "SA Histogram", 0));
        lbl_SmRainflow->setText(QApplication::translate("MainWindow", "SM Histogram", 0));
    } // retranslateUi
